import Swal from 'sweetalert2';import { Component, OnInit ,AfterViewInit, ViewChild } from '@angular/core';
 ...
 @ViewChild(MatPaginator) paginacionTabla! :MatPaginator
  ...
  nuevoProducto(){
    this.dialog.open(ModalProductoComponent,{
      disableClose : true   /* para que evite el cerrar el modal cuando ponga click afuera */
    }).afterClosed().subscribe(resultado => {   /* esperamos la respuesta del modal, devuelve una rpta cuando se cierra */
